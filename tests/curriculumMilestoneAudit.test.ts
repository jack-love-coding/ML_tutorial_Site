...
test('milestone audit documents every completed phase and the current refactor state', () => {
  ...
  assert.match(stateSource, /Phase 11 data pipeline task lab implemented and verified/)
  assert.match(stateSource, /Phase 12 Data-first Corridor Audit is next/)
  assert.match(stateSource, /Phase 13 categorical vocabulary contract/)
