...
test('milestone audit documents every completed phase and the current refactor state', () => {
  ...
  assert.match(stateSource, /Python Data Tools Stage 4 implementation plan is independently verified as 12 plans across 9 waves; execution has not started/)
  ...
  assert.match(stateSource, /Current focus:\*\* Review and explicitly approve execution of the verified Stage 4 plan before changing runtime code; Plan 06 retains the blocking Plotly package approval checkpoint\./)
})
