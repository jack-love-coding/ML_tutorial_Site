...
test('milestone audit documents every completed phase and the current refactor state', () => {
  ...
  assert.match(stateSource, /Current focus:\*\* Execute Phase 25 from the verified UCI Banknote logistic-regression plan/)
  ...
  assert.match(stateSource, /Numerical Methods Batch 4 Phase 25 planning is verified and its 13 plans are ready to execute in 8 waves/)
