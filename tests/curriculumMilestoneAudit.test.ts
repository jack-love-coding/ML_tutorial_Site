...
test('milestone audit documents every completed phase and the current refactor state', () => {
  ...
  assert.match(stateSource, /Current focus:\*\* Discuss and contract Numerical Methods Batch 4/)
  ...
  assert.match(stateSource, /Numerical Methods Batch 4 \(`numerical-optimization`, `training-diagnostics`\) is next for discussion and planning/)
})
