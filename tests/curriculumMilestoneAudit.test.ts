...
test('milestone audit documents every completed phase and the current refactor state', () => {
  ...
  assert.match(stateSource, /Phase 16 curriculum role metadata and legacy order cleanup completed/)
  assert.match(stateSource, /Phase 17 neural-network learning mechanism bridge/)
  ...
  assert.match(stateSource, /Current focus:\*\* Required-core content quality and explicit neural-network learning depth/)
})
