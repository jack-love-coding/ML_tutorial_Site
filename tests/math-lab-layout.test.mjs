...
test('math lab components and labs exist with expected contracts', () => {
  ...
  assert.doesNotMatch(homeViewSource, /modules\/math-lab\/data\/modules/)
  assert.match(homeViewSource, /migrateLearningProgressV2/)
  assert.match(homeViewSource, /selectContinueLearning/)
  assert.match(homeViewSource, /curriculumNavigationMenus/)
  assert.match(homeViewSource, /const learningProgress = ref<LearningProgressV2>\(createDefaultLearningProgressV2\(\)\)/)
  assert.match(homeViewSource, /function refreshLearningProgress\(\)/)
  assert.match(homeViewSource, /window\.addEventListener\('focus', refreshLearningProgress\)/)
  ...
  assert.match(homeViewSource, /window\.removeEventListener\('focus', refreshLearningProgress\)/)
