"""High-contrast ML Atlas visual tokens for numerical-methods Batch 4."""
...
# Named semantic aliases keep the shared contrast contract visible to every scene.
HIGH_CONTRAST_TEXT = NAVY
HIGH_CONTRAST_SURFACE = PAPER
STATUS_REFERENCE = DATA_BLUE
STATUS_SUCCESS = TEAL
