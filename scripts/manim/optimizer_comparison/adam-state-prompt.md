...
0:27–0:36: Arrive at the labelled minimum and hold the conclusion `state changes the next step`. Keep exact raw LaTeX and poster-compatible layout.
