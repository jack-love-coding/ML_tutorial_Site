...
const momentumRmsprop = [
  ...
  block('math-state', '$$v_t=\\beta v_{t-1}+g_t,\\quad \\theta\\leftarrow\\theta-\\eta v_t$$\\n$$s_t=\\alpha s_{t-1}+(1-\\alpha)g_t^2,\\quad \\theta\\leftarrow\\theta-\\eta g_t/(\\sqrt{s_t}+\\epsilon)$$', '$$v_t=\\beta v_{t-1}+g_t,\\quad \\theta\\leftarrow\\theta-\\eta v_t$$\\n$$s_t=\\alpha s_{t-1}+(1-\\alpha)g_t^2,\\quad \\theta\\leftarrow\\theta-\\eta g_t/(\\sqrt{s_t}+\\epsilon)$$'),
...
const adamWeightDecay = [
  ...
  block('math-state', '$$m_t=\\beta_1m_{t-1}+(1-\\beta_1)g_t,\\quad v_t=\\beta_2v_{t-1}+(1-\\beta_2)g_t^2$$\\n$$\\hat m_t=m_t/(1-\\beta_1^t),\\quad \\hat v_t=v_t/(1-\\beta_2^t)$$\\nAdamW 在自适应更新之外衰减权重。', '$$m_t=\\beta_1m_{t-1}+(1-\\beta_1)g_t,\\quad v_t=\\beta_2v_{t-1}+(1-\\beta_2)g_t^2$$\\n$$\\hat m_t=m_t/(1-\\beta_1^t),\\quad \\hat v_t=v_t/(1-\\beta_2^t)$$\\nAdamW decays weights outside the adaptive update.'),
