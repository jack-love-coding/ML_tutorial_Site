...
REF-HF-LLM-COURSE, REF-D2L-TRANSFORMER`,
      ...
      loc(
        '在右侧 tools 阶段，把 tokenizer、model、attention mask、logits 对应回前面的形状和计算。',
        'Use the tools stage to map tokenizer, model, attention mask, and logits back to the shapes and computations above.',
      ),
    ),
  ],
  controls: [],
