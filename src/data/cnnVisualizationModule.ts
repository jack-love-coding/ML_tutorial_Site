...
### Ref ID
REF-CONV-ARITHMETIC、REF-D2L-CNN`,
...
### Ref ID
REF-PYTORCH-CV-TRANSFER、REF-CS231N-CNN`,
...
REF-PYTORCH-CV-TRANSFER, REF-CS231N-CNN`,
  ...
  presets: [],
  sourceNote: loc(
    '统一资料入口：REF-CS231N-CNN、REF-D2L-CNN、REF-PYTORCH-CV-TRANSFER、REF-CONV-ARITHMETIC。',
    'Centralized references: REF-CS231N-CNN, REF-D2L-CNN, REF-PYTORCH-CV-TRANSFER, REF-CONV-ARITHMETIC.',
  ),
  createDefaultConfig: () => ({
    playbackMs: 900,
  }),
