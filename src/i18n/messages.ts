export const messages = {
  'zh-CN': {
    ...
    home: {
      ...
      pathTitle: '学习路径',
      pathBody: '推荐顺序是数学直觉、数据处理、机器学习模型、深度学习扩展。',
      path: [
        'Math Lab：向量、矩阵、概率、优化和自动微分',
        'Data Lab：数值、类别、清洗、EDA、划分和正则化',
        'ML Models：loss、回归、分类评估和 MLP',
        'Deep Learning：从 MLP 延伸到深度架构数学',
      ],
      modulesTitle: '学习闭环模块',
    ...
    modules: {
      ...
      housingPriceProject: {
        ...
        summary: '使用冻结在本地的完整 California Housing 数据，把训练集 EDA、防泄漏 Pipeline、线性 baseline、验证选择和残差复盘连成一个项目闭环。',
        sections: {
          csvToFrame: {
  ...
  en: {
    ...
    home: {
      ...
      posterTitle: 'Math Lab → Data Lab → ML Models',
      posterBody:
        'Build math intuition first, shape data inputs next, then observe model training, evaluation, and representations through interactive labs.',
      pathTitle: 'Learning path',
      pathBody:
        'The recommended order is math intuition, data processing, machine-learning models, and deep-learning extensions.',
      path: [
        'Math Lab: vectors, matrices, probability, optimization, and autodiff',
        'Data Lab: numeric, categorical, cleaning, EDA, splits, and regularization',
        'ML Models: loss, regression, classification evaluation, and MLP',
        'Deep Learning: extend from MLP into architecture math',
      ],
      modulesTitle: 'Learning-loop modules',
      modulesBody: 'Each module combines explanation, lab work, feedback, and a next step so students can check understanding.',
      modulesNote:
    ...
    modules: {
      ...
      housingPriceProject: {
        ...
        summary:
          'Use the full locally frozen California Housing dataset to connect training-only EDA, a leakage-safe Pipeline, a linear baseline, validation selection, and residual review.',
        sections: {
          csvToFrame: {
