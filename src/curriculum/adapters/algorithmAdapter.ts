...
const algorithmManifests: AlgorithmModuleManifest[] = [
  ...
  },
  {
    ...
    level: 'beginner',
    lessons: [
      { id: 'fit-line', titleKey: 'modules.linearRegression.sections.fitLine.title' },
      { id: 'multivariate', titleKey: 'modules.linearRegression.sections.multivariate.title' },
      { id: 'residual-loss', titleKey: 'modules.linearRegression.sections.residualLoss.title' },
      { id: 'training-motion', titleKey: 'modules.linearRegression.sections.trainingMotion.title' },
      { id: 'polynomial', titleKey: 'modules.linearRegression.sections.polynomial.title' },
      { id: 'model-limits', titleKey: 'modules.linearRegression.sections.modelLimits.title' },
      { id: 'overfitting', titleKey: 'modules.linearRegression.sections.overfitting.title' },
      { id: 'regularization', titleKey: 'modules.linearRegression.sections.regularization.title' },
    ],
    prerequisites: ['loss-functions'],
  },
  {
