...
**Status:** In progress; AI Overview rebuild, Math-to-Code pilot, and Python Data Tools Stages 1–3 completed; Python Data Tools Stage 4 specification approved and implementation not started.
...
4. **English parity and runtime refactor** — Current — specification approved; English parity and migrate existing `python-notebook` route to new contract after implementation discussion and plan approval.
