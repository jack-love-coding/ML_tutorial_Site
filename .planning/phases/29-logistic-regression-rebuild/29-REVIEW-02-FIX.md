...
- **WR-02:** Added finite timeouts, spawn/error handling, stderr capture, process-group termination, bounded forced cleanup, and deterministic process-lifecycle tests.
