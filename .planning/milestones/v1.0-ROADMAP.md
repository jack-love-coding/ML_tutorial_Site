...
- Preserve legacy routes and all three v1 progress stores through gradual migration.
- Use adapters and typed schemas before moving large amounts of lesson content.
- Prioritize detailed, reproducible teaching content over additional frontend progress mechanics.
- Keep checkpoint persistence deferred until backend identity, synchronization, and ownership are designed.

**Issues resolved:**

- Unified curriculum catalog, route compatibility, progress migration, navigation, and LessonPage pilots were implemented.
- Canonical Math/Data lesson URLs now preserve safe lesson identity and query state.
- Phase 25 completed a fully reproducible optimization and training-diagnostics case with automated and browser verification.

**Issues deferred:**

- Historical Phases 1–24A lack canonical requirement/verification/summary provenance.
- CURR-04, PROG-04, HOME-01, HOME-02, LESSON-01, LAB-02, and VAL-04 remain partial or narrowed.
- Homepage Focus, Spine progressive disclosure, and Python Data Tools Stage 5 remain paused.

**Technical debt:**

- Multiple synchronized curriculum order inventories still require careful drift checks.
- Checkpoint components do not yet persist completion or attempts.
- Some older workflow surfaces still use experiment-oriented labels without satisfying the full interaction protocol.

---
*Roadmap created: 2026-06-25*
*Archived: 2026-07-26 with user-approved gaps*
